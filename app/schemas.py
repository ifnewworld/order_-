...
class OrderBase(BaseModel):
    ...
    rocket_inbound_requested: bool = Field(False, description="로켓그로스 입고 신청 여부")
    rocket_inbound_completed: bool = Field(False, description="로켓그로스 입고 완료 여부")
...
class OrderUpdate(BaseModel):
    ...
    rocket_inbound_requested: Optional[bool] = None
    rocket_inbound_completed: Optional[bool] = None
